...
| 47.py     | Reverse a string     |
| 48.py     | Convert lowercase to uppercase (without built-in functions)|
...
| 4    | Union of Two Arrays (Without using set)| Combine arrays and return unique elements without using set                 | array_04.py |
